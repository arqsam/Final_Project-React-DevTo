...
export default function Online() {
  ...
  return (
    <div className="flex flex-space-4 gap-2 items-center justify-center">
      ...
      <a className="px-3 h-9 align-middle hover:rounded-sm hover:bg-indigo-200/50 hover:text-indigo-600">
        <Icon></Icon>
      </a>
      <Menu>
        <MenuHandler>
          <Avatar
            variant="circular"
            alt="tania andrew"
            className="cursor-pointer hover:outline hover:outline-indigo-200/50 w-10 h-10 "
