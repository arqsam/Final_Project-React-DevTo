      ...
      <div className="container mx-auto">
        <nav className="flex flex-col col-span-1 border gap-2 bg-white rounded-xl shadow-md mx-80 my-10 p-6 justify-center">
          ...
          <div className="flex flex-col">
            ...
            <input
              type="text"
              className="border rounded-md shadow-sm h-10 hover:border-gray-500/60"
            />
            <label htmlFor="user_email" className="font-semibold mb-2 mt-2">
              Password
            </label>
            <input
              type="text"
          ...
          <button className="w-full h-12 rounded-lg bg-indigo-600 hover:bg-indigo-800 font-sans text-white font-bold">
            {" "}
            Continue{" "}
          </button>
          <a
